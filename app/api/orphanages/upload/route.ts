...
const BUCKET = 'orphanage-photos';
const MAX_BYTES = 5 * 1024 * 1024;

/**
 * POST /api/orphanages/upload (multipart form, field "file")
 * Uploads an orphanage photo to the public `orphanage-photos` bucket and
 * returns its public URL. Mirrors the S-Wall media upload route.
 */
