...
-- (scripts/apply-employee-support-triage-migration.mts) owns the transaction.
...
begin
  ...
  if drift is not null then
    raise notice
      'employee_notifications_type_check allows % which this file did not expect. KEPT — update the header of references/sql/alter/2026-09-21_support_notification_types.sql.',
      drift;
  end if;
