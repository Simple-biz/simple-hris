// ─────────────────────────────────────────────────────────────────────────────
// DORMANT — parked to save Supabase Realtime message quota (2026-07-11).
//
// Live keystroke-level cell co-editing was removed from the New Hire Checklist
// (adds now go through the "New Hire" button → NewHireQuickAddDialog). This hook
// is intentionally kept — not deleted — for likely reuse. The full original
// implementation is preserved below, line-commented so it is NOT compiled or
// shipped. To revive: strip the leading "// " from the block below (and re-check
// imports in peer-color.ts).
// ─────────────────────────────────────────────────────────────────────────────
