...
// Bulk row selection + runBulk/reportBulk live in src/components/mesa/bulk-selection.tsx
// (shared with HR -> MESA -> FPU since 2026-09-16).
...
function MesaNonMembers() {
  ...
  const exportSpec = useMemo<MesaExportSpec>(() => {
    ...
    return {
      ...
      notes: [
        'Not enrolled: never joined, or opted out. Opting a former member back in opens a fresh account; the closed one stays in the ledger.',
      ],
    };
