      ...
      {state.locked && !collapsed && (
        ...
        >
          ...
          {/* Indeterminate progress line along the bottom edge. The track is always
              ...
              Motion lives in index.css (`.payroll-lock-sweep`). */}
          <div
            className="relative h-[2px] overflow-hidden bg-rose-300/60 dark:bg-rose-800/60"
            aria-hidden
          >
            <div className="payroll-lock-sweep absolute inset-y-0 left-0 w-2/5 bg-gradient-to-r from-transparent via-amber-400 to-transparent dark:via-amber-300" />
          </div>
        </motion.div>
      )}
    </AnimatePresence>
