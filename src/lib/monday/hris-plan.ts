...
export const PLAN_TASKS: PlanTask[] = [
  ...
  // Rolled S27 → S28 on 2026-09-01: unfinished at sprint close. Status untouched by the move.
  { epic: 'HRIS-15', name: 'Audit writes fail silently: insertAuditLog’s error is discarded at 197 of 201 call sites', type: 'Bug', sp: 3, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-03a', name: 'Stop Processing can no longer file a just-paid person as unpaid — the close-out prunes reconciled-paid employees', type: 'Bug', sp: 2, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-06', name: 'Payment Catalog Pay Processors tab — the source-of-truth registry of send-from processors and their 1:1 rails', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-02a', name: 'Wizard Lock-in button greys out once the cycle is locked and sent to Payment Dispatch', type: 'Bug', sp: 2, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-06', name: 'Edit Department on every Payment Catalog card — rename by alias, sub-department restructure, people moves, CAS-guarded; master-list cards for managers only', type: 'Feature', sp: 8, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-26', name: 'angelicac@ transfer backfill script — the transfer HRIS never filed, replayed through the three Release helpers in order, dry-run by default', type: 'Chore', sp: 2, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-28', name: 'Admin Penny becomes an operator console — NUL-delimited activity frames report the real tool, Opus 5 engine with refusal fallback, /clear', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-15', name: 'Diagnostics → Payroll Cycle Performance and HR Pipeline tabs — one honest rate each from close-outs, every cycle listed, and a progress bar that cannot finish early', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-06', name: 'A failed Payment Catalog read no longer renders an empty catalog in silence', type: 'Bug', sp: 1, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-02a', name: 'COP people see COP — a per-person settlement currency, display-only, on the Payroll Wizard, both KPI calculators, Mark Paid and the Processor Queue', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-06', name: 'Settlement-currency fetch was cancelled by every dependency change and never retried — only an unmount may drop a response', type: 'Bug', sp: 2, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-30', name: 'HSL Managers Weekly realigned to the dated 2026-08-30 sheet — banded weekly tiers, three new managers, Pre/Post-Hearing ₱2,500 monthly final-week box outside the cap, Case Managers SSA.Gov ×₱250', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-30', name: 'SSD Medical Records and Collections monthly flat bonuses auto-dispatch again — Ready is the trigger, and the monthly share sums with the weekly bonus', type: 'Bug', sp: 2, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-30', name: 'HSL KPI bonus is paid for every scored person, not only hogan_smith_law home-department master rows', type: 'Bug', sp: 2, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-06', name: 'Bonus Library carries a version and an effective date per bonus, with version and assignment history in the modal — display and audit only, the calculator pays the live definition', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-02b', name: 'PAB step: HSL wins when a person has two master rows and the step says whose department was guessed; the Additions review re-gates PAB off payout weeks', type: 'Bug', sp: 3, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-02a', name: 'Payroll Wizard Reports step gets a search bar — display only, exports and the cycle Total never narrow', type: 'Feature', sp: 1, done: true, sprint: 'S28', priority: 'Low' },
  ...
  { epic: 'HRIS-05', name: 'Accounting tab cache gets an identity envelope and a sign-out purge so pay data cannot survive into the next account; HR cache gains a 30 s freshness window', type: 'Bug', sp: 5, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-15', name: 'One audit-action registry behind the panel, Penny and every write path — source-scan test fails the build on an unregistered action, actor from the session never the body, dated purge with a 90-day floor', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-09', name: 'Employee PAB card explains the right rule in all four places, and "Not met" drills into the calendar', type: 'Bug', sp: 2, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-09', name: 'My Hours becomes Time Adjustments, and red days ask for one — a persistent mark, a 5 s looping bubble and a permanent count, shuffled by seed', type: 'Feature', sp: 3, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-16', name: 'QC weekly deal is genuinely random — seeded per (period_start, department), Callback retired from QC_DEPT_KEYS, and the surface gets its first feature doc', type: 'Bug', sp: 3, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-16', name: 'QC: paste Jackie’s sheet, Compare it with the first pass in four buckets, Override via setVar only, Undo in memory', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-06', name: 'KPI calculators score the upcoming pay week before its Hubstaff file exists, and kpi.published tells Accounting on publish', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'High' },
  ...
  { epic: 'HRIS-06', name: 'Lead Gen card header — Compare chip beside Payout with motion, Offboarded last pay behind a header chip, week picker border restored', type: 'Feature', sp: 2, done: true, sprint: 'S28', priority: 'Low' },
  ...
  { epic: 'HRIS-10', name: 'Manager Overview rebuilt — what needs me on the left as one ordered queue, the roster on the right, four stat cells, and no page scroll at lg and up', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  { epic: 'HRIS-18', name: 'The COE states the profile role and the bonuses earned over the last 4 pay cycles, through the one reader the paystub modal already uses', type: 'Feature', sp: 5, done: true, sprint: 'S28', priority: 'Medium' },
  ...
  // —── PASS 33 · 2026-09-23 · Sep 21-23, 33 rows, 129 SP — the commits no row had claimed ──────
  // Kane: "All withheld SP lets push to Sprint 29". The pending ledger owed 0 and pass 31 was already
  // applied, so the withheld SP was the third waiting room: 76 commits after 7c880535 with no row.
  // Clustered by FILE OVERLAP; 53 commits make these 33 rows, the other 23 are audit notes, board
