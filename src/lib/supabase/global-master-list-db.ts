...
/* The Google-Sheet ingestion pair that used to live here —
 * `applyOffboardedFromSheetRows` (stamp master rows from the sheet's Offboarded
 * tab) and `replaceOffboardedSheetSnapshot` (DELETE-all + re-INSERT
