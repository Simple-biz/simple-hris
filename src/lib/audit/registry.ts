...
export const AUDIT_FAMILIES: readonly AuditFamily[] = [
  ...
  },
  {
    ...
    surfaces: ['accounting', 'manager'],
    label: 'QC scoring',
    note: 'review.*, scores.locked/reopened, compare_override_applied, missing_added, compare_paste_saved/cleared',
  },
  {
    match: 'mesa.',
    surfaces: ['accounting'],
  ...
  },
  {
    ...
    label: 'Gift tracker',
    note: 'catalog_saved, tracker_note_saved, payment_edited, order_locked (details: order_no, gifts, qty, total_centavos, submission_ids), order_reopened (details: reason), order_deleted (details: the WHOLE order as it was: snapshot, lines, totals, who locked/reopened it; the only record once the row is gone)',
  },
  {
  ...
  },
  {
    ...
    surfaces: ['hr', 'employee'],
    label: 'FPU enrolment',
    note: 'enroll (employee) · class.created/updated/deleted/enrollment_closed/enrollment_reopened/closed · enrollment.approved/denied/reset/completed/deleted · groups.divided/leader_set/leader_cleared · attendance.marked',
  },
