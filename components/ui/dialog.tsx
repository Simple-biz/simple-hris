...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-gradient-to-br from-orange-950/40 to-blue-950/40 backdrop-blur-[2px] dark:from-black/75 dark:to-blue-950/60",
        "duration-[280ms] ease-out data-open:animate-in data-open:fade-in-0",
        "data-closed:animate-out data-closed:fade-out-0 data-closed:duration-[180ms] data-closed:ease-in",
        className
      )}
      {...props}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border border-border p-4 text-sm text-popover-foreground shadow-2xl shadow-zinc-950/15 ring-0 outline-none sm:max-w-sm dark:shadow-black/40",
