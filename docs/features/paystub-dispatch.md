...
| `pay_php.perfect_attendance_bonus` | `pabPayoutForWeek(...).pays && toggles.perfect_attendance ? 5000 : 0`. Attaches on the weekly paystub AFTER the one closing the PAB period (Kane 2026-09-08), never on the closing week. |
